...
TEST_F(ServiceDiscoveryClientFindServiceFixture, FindServiceReturnHandlesForAny)
{
    ...
    const auto expected_handle_0 =
        make_HandleType(kConfigStoreFindAny.GetInstanceIdentifier(),
                        ServiceInstanceId{LolaServiceInstanceId{kConfigStoreQm1.lola_instance_id_.value()}});
    const auto expected_handle_1 =
        make_HandleType(kConfigStoreFindAny.GetInstanceIdentifier(),
                        ServiceInstanceId{LolaServiceInstanceId{kConfigStoreQm2.lola_instance_id_.value()}});
